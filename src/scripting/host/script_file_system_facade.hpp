...
public:
    ...
    virtual std::tuple<sol::object, sol::object> close(ScriptHostContextInternal& ctx, std::uint64_t handle) = 0;
    virtual std::tuple<sol::object, sol::object> stat(ScriptHostContextInternal& ctx, const std::string& path) = 0;
