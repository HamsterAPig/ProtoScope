...
namespace {
    ...
    constexpr std::array<ShortcutDescriptor, 25> kShortcutDescriptors{{
        ...
        {ShortcutAction::ReloadConfig,
         ...
         "Ctrl+R",
         "重新加载配置文件"},
        {ShortcutAction::ReloadProtocol, ShortcutScope::Global, {.key = ShortcutKey::F5}, "F5", "重新加载当前协议"},
        ...
        {ShortcutAction::ToggleRawRecording,
         ...
         "Ctrl+Shift+R",
         "开始或停止完整原始数据录制"},
        {ShortcutAction::PlaybackTogglePlayPause,
         ShortcutScope::Global,
         {.key = ShortcutKey::F6},
         "F6",
         "继续或暂停原始回放"},
        {ShortcutAction::PlaybackStepForward,
         ShortcutScope::Global,
         {.key = ShortcutKey::F7},
         "F7",
         "单步推进原始回放"},
        {ShortcutAction::PlaybackUnloadTimeline,
         ShortcutScope::Global,
         {.key = ShortcutKey::F7, .shift = true},
         "Shift+F7",
         "停止并卸载原始回放时间轴"},
        ...
        {ShortcutAction::ToggleWaveDock,
         ...
         "Ctrl+8",
         "显示或隐藏波形 Dock"},
        {ShortcutAction::ShowShortcutHelp, ShortcutScope::Global, {.key = ShortcutKey::F1}, "F1", "打开快捷键说明"},
        {ShortcutAction::WaveTogglePauseFollow,
         ShortcutScope::WaveDock,
         {.key = ShortcutKey::Space},
         "Space",
         "暂停或恢复波形自动跟随"},
        {ShortcutAction::WaveFitVisible, ShortcutScope::WaveDock, {.key = ShortcutKey::A}, "A", "适配当前可见波形"},
        {ShortcutAction::WaveToggleZoomSelection,
         ShortcutScope::WaveDock,
         {.key = ShortcutKey::Z},
         "Z",
         "切换框选放大模式"},
        {ShortcutAction::WaveToggleFft, ShortcutScope::WaveDock, {.key = ShortcutKey::F}, "F", "切换 FFT 频谱模式"},
