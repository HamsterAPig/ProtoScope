...
namespace {
    ...
    public:
        ...
        {
            check(sqlite3_prepare_v2(db_, sql, -1, &statement_, nullptr), db_);
        }
        ...
        std::string text(int index) const
        {
            ...
            return text ? std::string(reinterpret_cast<const char*>(text), sqlite3_column_bytes(statement_, index))
                        : std::string{};
        }
