...
static const TestCase kAllTests[] = {
    ...
    {"lua_dock_settings_filter_keeps_only_current_windows", &test_lua_dock_settings_filter_keeps_only_current_windows},
    {"lua_dock_settings_filter_removes_lua_windows_when_no_docks", &test_lua_dock_settings_filter_removes_lua_windows_when_no_docks},
    {"workspace_layout_mode_after_load_uses_existing_layout_apply", &test_workspace_layout_mode_after_load_uses_existing_layout_apply},
    {"workspace_layout_mode_after_loaded_apply_becomes_ready", &test_workspace_layout_mode_after_loaded_apply_becomes_ready},
