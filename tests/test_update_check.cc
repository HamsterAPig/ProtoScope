...
{
    const auto result = protoscope::ui::evaluateUpdateCheckTags(kTagsJson,
...
void test_update_check_reports_development_build()
{
    ...
    require(result.state == protoscope::ui::UpdateCheckResult::State::DevelopmentBuild,
            "非精确标签构建应标记为开发构建");
...
{
    const auto result = protoscope::ui::evaluateUpdateCheckTags(R"json([{"name": "latest"}, {"name": "v1.2"}])json",
                                                                protoscope::ui::BuildVersionInfo{
                                                                    .version = "v1.0.0",
                                                                    .currentTag = "v1.0.0",
                                                                    .baseTag = "",
