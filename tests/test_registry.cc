...
static const TestCase kAllTests[] = {
    ...
    {"wave_overview_bit_config", &test_wave_overview_bit_config},
    ...
    {"ui_theme_professional_dark_preserves_existing_tokens",
     &test_ui_theme_professional_dark_preserves_existing_tokens},
    {"ui_theme_high_contrast_tokens_and_grid_contrast", &test_ui_theme_high_contrast_tokens_and_grid_contrast},
    ...
    {"config_gui_theme_values_and_fallback", &test_config_gui_theme_values_and_fallback},
    ...
    {"application_set_gui_theme_updates_runtime_without_protocol_reload",
     &test_application_set_gui_theme_updates_runtime_without_protocol_reload},
    ...
    {"bit_cursor_edge_priority_and_stable_fallback", &test_bit_cursor_edge_priority_and_stable_fallback},
    {"hidden_bit_lane_excluded_from_layout_hit_and_snap", &test_hidden_bit_lane_excluded_from_layout_hit_and_snap},
    {"bit_snap_uses_sample_frequency_display_time_and_source_index",
     &test_bit_snap_uses_sample_frequency_display_time_and_source_index},
    ...
    {"bit_cursor_pair_switches_measurement_mode", &test_bit_cursor_pair_switches_measurement_mode},
    {"bit_display_cursor_falls_back_to_waveform", &test_bit_display_cursor_falls_back_to_waveform},
    ...
    {"bit_cursor_can_return_nearby_waveform", &test_bit_cursor_can_return_nearby_waveform},
    {"bit_display_cursor_excludes_same_channel_raw_waveform",
     &test_bit_display_cursor_excludes_same_channel_raw_waveform},
    {"explicit_bit_readout_policy_keeps_waveform_outside_lane",
     &test_explicit_bit_readout_policy_keeps_waveform_outside_lane},
    ...
    {"wave_cursor_metrics_degrade_without_complete_readouts",
     &test_wave_cursor_metrics_degrade_without_complete_readouts},
    ...
    {"wave_channel_scale_value_per_division_conversions", &test_wave_channel_scale_value_per_division_conversions},
    {"wave_channel_scale_wheel_engineering_steps", &test_wave_channel_scale_wheel_engineering_steps},
    {"wave_channel_scale_wheel_acceleration_and_reset", &test_wave_channel_scale_wheel_acceleration_and_reset},
    {"wave_channel_scale_wheel_disabled_uses_legacy_zoom", &test_wave_channel_scale_wheel_disabled_uses_legacy_zoom},
    {"wave_channel_scale_wheel_fine_adjustment", &test_wave_channel_scale_wheel_fine_adjustment},
    {"wave_wheel_fine_adjustment_shortcut_and_fit_binding", &test_wave_wheel_fine_adjustment_shortcut_and_fit_binding},
    ...
    {"wave_viewport_animation_disabled_jumps_to_target", &test_wave_viewport_animation_disabled_jumps_to_target},
    ...
    {"wave_cursor_owns_channel_interaction_and_stacked_blocks_vertical_drag",
     &test_wave_cursor_owns_channel_interaction_and_stacked_blocks_vertical_drag},
    {"wave_view_mode_isolates_stacked_vertical_range", &test_wave_view_mode_isolates_stacked_vertical_range},
    {"wave_stacked_unlock_reapplies_vertical_fit", &test_wave_stacked_unlock_reapplies_vertical_fit},
