...
const TestCase kHeadlessTests[] = {
    ...
    {"script_runtime_worker_can_disable_adjacent_rx_merge", &test_script_runtime_worker_can_disable_adjacent_rx_merge},
    ...
    {"application_raw_capture_import_batches_small_rx_events",
     &test_application_raw_capture_import_batches_small_rx_events},
