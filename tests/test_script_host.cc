...
static const TestCase kAllTests[] = {
    ...
    {"frame_stream_parser_default_grows_without_drop_oldest", &test_frame_stream_parser_default_grows_without_drop_oldest},
    ...
    {"application_plot_push_drains_with_budget_and_disconnect_keeps_pending", &test_application_plot_push_drains_with_budget_and_disconnect_keeps_pending},
    ...
    {"wave_edge_render_data_keeps_adjacent_guard_points", &test_wave_edge_render_data_keeps_adjacent_guard_points},
    {"wave_edge_render_data_keeps_sample_frequency_axis", &test_wave_edge_render_data_keeps_sample_frequency_axis},
