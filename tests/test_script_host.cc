...
static const TestCase kAllTests[] = {
    ...
    {"bit_hover_readout_prefers_same_channel_waveform_when_enabled",
     &test_bit_hover_readout_prefers_same_channel_waveform_when_enabled},
    {"bit_hover_readout_prefers_waveform_in_mixed_view_when_enabled",
     &test_bit_hover_readout_prefers_waveform_in_mixed_view_when_enabled},
